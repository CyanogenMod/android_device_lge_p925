...
void overlay_control_context_t::calculateDisplayMetaData(overlay_object *overlayobj, int panelId)
{
    ...
    static const char* panelname = "2lcd";
    static const char* managername = "2lcd";
                                        ...
                                        uint32_t w, uint32_t h, int32_t  format, int isS3D)
{
    ...
    * */
    ...
    if (!isS3D) {
        LOGD("Writing 'lcd' to %s",overlayobj->overlaymanagerpath);
      if (sysfile_write(overlayobj->overlaymanagerpath, "2lcd", sizeof("2lcd")) < 0) {
